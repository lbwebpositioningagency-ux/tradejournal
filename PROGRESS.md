...
## Radar di settore — la nona sezione del Macro Desk (27/08/2026)
...
### Non una nona pillola: un terzo gruppo

`MACRO_DESK_SECTIONS` aveva due gruppi (`quotidiano` 6 · `archivio` 2). Il
Radar ne apre un terzo, `registro`, e sta **fuori dalla griglia** della barra,
sotto un filo e allineato a destra. Aggiungerlo come nona voce accanto alle
sezioni di mercato avrebbe detto il falso su cosa contiene. Stessa scelta
nell'indice `/macro-desk`: un blocco «Registro» in fondo, separato.
