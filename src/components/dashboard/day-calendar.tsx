              ...
              return (
                <div key={week[0]} className="contents">
                  {week.map((date) => {
                    ...
                    // Senza trade: un gradino di blu sopra la card (--viz-day-empty),
                    // perché la griglia si legga; nessun bordo.
                    const tone = data
                      ? dayTone(data.netPnl)
                      : "border-transparent bg-viz-day-empty hover:border-foreground/40";
